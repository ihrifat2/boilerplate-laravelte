...
<MainApp>
            ...
            <li>
                ...
                >
                    <svg
                        ...
                        width="1em"
                        height="1em"><use href="#sun-fill" /></svg
                    >
                    Light
            ...
            <li>
                ...
                >
                    <svg
                        class="bi me-2 opacity-50 theme-icon"
                        width="1em"
                        height="1em"><use href="#moon-stars-fill" /></svg
                    >
                    Dark
                    <svg class="bi ms-auto d-none" width="1em" height="1em"
                        ><use href="#check2" /></svg
            ...
            <li>
                ...
                >
                    <svg
                        class="bi me-2 opacity-50 theme-icon"
                        width="1em"
                        height="1em"><use href="#circle-half" /></svg
                    >
                    Auto
                    <svg class="bi ms-auto d-none" width="1em" height="1em"
                        ><use href="#check2" /></svg
            ...
            <div class="col-md-8">
                ...
                <article class="blog-post">
                    ...
                    <p>
                        ...
                        repetitive body text used throughout. This is an example
                        unordered list:
                    </p>
                    <ul>
                    ...
                    <p>
                        ...
                        complete list of which can be found on the <a
                ...
                <article class="blog-post">
                    ...
                    <blockquote>
                        <p>
                            Longer quote goes here, maybe with some <strong
    ...
    <footer class="blog-footer">
        <p>
            Blog template built for <a href="https://getbootstrap.com/"
                >Bootstrap</a
            >
